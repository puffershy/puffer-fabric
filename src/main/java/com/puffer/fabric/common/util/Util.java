...
package com.puffer.fabric.common.util;

import com.puffer.fabric.user.CAEnrollment;
...
public class Util {
    ...
    public static CAEnrollment getEnrollment(String keyFolderPath, String keyFileName, String certFolderPath, String certFileName)
        ...
        try {
            ...
            certificate = new String(IOUtils.toByteArray(new FileInputStream(certFolderPath + File.separator + certFileName)));
